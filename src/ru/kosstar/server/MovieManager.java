...
public class MovieManager {
    ...
    private void createCommands() {
        ...
        commands.put("save", new SaveCommand("save", "сохранить коллекцию в файл", this));
        commands.put("execute_script", new ExecuteScriptCommand("execute_script", "считать и исполнить скрипт из указанного файла", this));
        commands.put("exit", new EmptyCommand("exit", "завершение работы", this));
     ...
     */
    public String executeCommand(CommandWithArgument commandWithArgument) {
